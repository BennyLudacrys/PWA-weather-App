<template>
  <div id="main" :class="isDay ? 'day' : 'night'">
    <div class="container my-5" style="max-width: 400px; min-width: 360px">
      <h1 class="title text-center">Temperatura em: </h1>
      ...
      <p class="text-center my-3" v-if="cityFound">Nenhuma cidade encontrada</p>
      <div
...
<script>
  // import SearchComponentVue from "./components/TheSearchBar.vue";
